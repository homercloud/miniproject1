    ...
    <body>
        ...
        if(isset($_GET['del'])){
            if(unlink($_GET['del'])){
                ...
                $status = "<font color='green'>Arquivo <b>".$_GET['del']."</b> excluído com sucesso.</font>&nbsp;&nbsp;<a href='index.php'>Retomar Upload</a>";
                $noupload = 1;
            }
        }
        if(isset($_FILES['arquivo'])){
            ...
            elseif($arquivo['size'] > 2097152)   //Caso o atributo "upload_max_filesize" no arquivo "php.ini" esteja configurado com valor acima do padrão (2MB).
                ...
                <?php
                    ...
                    foreach (new DirectoryIterator($path) as $img) {
                        ...
                        <tr>
                            ...
                            <td>".$dth_envio."</td>
                            <td><a href='index.php?del=".$path.$img."'>Apagar</a></td>
                        </tr>";
                    }
                    //$diretorio->close();
                ?>
